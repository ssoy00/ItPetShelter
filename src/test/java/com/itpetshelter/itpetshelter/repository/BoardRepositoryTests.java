...
import com.itpetshelter.itpetshelter.domain.BoardImage;
...
//        com.busanit501.boot501.domain.Board board = com.busanit501.boot501.domain.Board.builder()
        com.itpetshelter.itpetshelter.domain.Board board = com.itpetshelter.itpetshelter.domain.Board.builder()
...
//    Optional<Board> result = boardRepository.findById(1L);
        Optional<com.itpetshelter.itpetshelter.domain.Board> result = boardRepository.findByIdWithImages(1L);
        com.itpetshelter.itpetshelter.domain.Board board = result.orElseThrow();
