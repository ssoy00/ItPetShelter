...
import com.itpetshelter.itpetshelter.security.CustomUserDetailsService;
import com.itpetshelter.itpetshelter.security.handler.Custom403Handler;
...
public class CustomSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // 로그 아웃 설정.
        http.logout(
                logout -> logout.logoutUrl("/consumer/logout").logoutSuccessUrl("/consumer/login?logout")
